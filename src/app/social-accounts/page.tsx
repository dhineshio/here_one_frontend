...
function SocialAccountCard({ platform, icon, brandColor, followers, posts, engagement, isConnected }: { 
  platform: string; 
    ...
    <div className="rounded-lg border bg-card p-6">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-4">
          <div className={`p-3 rounded-lg bg-gradient-to-br ${brandColor}`}>
...
export default function SocialAccountsPage() {
  const socialAccounts = [
    ...
    },
    {
      platform: "Instagram", 
      icon: <InstagramIcon />,
      brandColor: "from-pink-500 to-orange-500",
      followers: "8.3K",
      posts: "156",
      engagement: "6.8%",
      isConnected: true
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold tracking-tight">Connect with Social Accounts</h1>
      </div>
